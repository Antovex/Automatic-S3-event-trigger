...
aws_region="<REGION>"
bucket_name="antarin-s3-event-triggering-bucket"
lambda_func_name="s3-lambda-function-test"
role_name="s3-lambda-sns-test"
email_address="<EMAIL>"
...
LambdaFunctionArn="arn:aws:lambda:<REGION>:$aws_account_id:function:s3-lambda-function"
...
aws sns publish \
  ...
  --message "Greetings from Antarin Ghosal, this is the response to the sns triggered"
